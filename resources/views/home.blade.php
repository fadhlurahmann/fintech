            ...
            <div class="col md-12">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row fw-bold" style="font-size: 15px;">
                            {{ Auth::user()->name}}
                        </div>
                    </div>
                </div>
...
<div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-header text-bg-secondary fw-bold text-center">Products</div>
                <div class="card-body">
                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                <div class="d-grip gap-2">
                                                    <button type="submit" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
        ...
        <div class="col-md-5">
            <div class="card mb-3">
                <div class="card-header text-bg-secondary fw-bold text-center">
                    Baskets
                </div>
                <div class="card-body">
                    <ul>
            ...
            <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-header text-center fw-bold text-bg-secondary">
                    Mutasi Wallet
                </div>
